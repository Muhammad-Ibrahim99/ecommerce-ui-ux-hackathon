...
const products = [
  ...
  },
  {
    ...
    discount: '20%',
    rating: '5/5',
    image: '/newArrivals/img-1.png',
  },
  {
    name: 'Checkered Shirt',
    price: '$180',
    rating: '4.5/5',
    image: '/newArrivals/img-2.png',
  },
  {
  ...
  return (
    <section className="py-8 bg-gray-50">
      <div className="max-w-6xl mx-auto px-4">
        <h2 className="text-3xl md:text-3xl font-extrabold text-center mb-6">NEW ARRIVALS</h2>
